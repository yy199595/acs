...
namespace Http
{
	...
	class Request : public IStream, public Tcp::ProtoMessage, public ILuaWrite
    {
    public:
	...
	protected:
		virtual void WriteMessageToLua(lua_State * lua) const = 0;
    public:
...
namespace Http
{
    ...
    protected:
		void WriteMessageToLua(lua_State *lua) const final;
