...
class client_category : public asio::error_category {
public:
...
inline asio::error_category& get_client_category() {
...
inline asio::error_category const& get_misc_category() {
...
inline asio::error_code make_error_code(client_errors e) {
