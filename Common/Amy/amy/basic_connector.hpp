...
public:
    ...
    std::string error_message(asio::error_code const& ec) {
    ...
    asio::error_code open(asio::error_code& ec) {
    ...
    template<typename Endpoint>
    asio::error_code connect(Endpoint const& endpoint,
                                      auth_info const& auth,
                                      std::string const& database,
                                      client_flags flags,
                                      asio::error_code& ec)
    ...
    asio::error_code query(std::string const& stmt,
                                    asio::error_code& ec)
    {
    ...
    result_set store_result(asio::error_code& ec) {
    ...
    asio::error_code autocommit(bool mode,
                                         asio::error_code& ec)
    {
    ...
    asio::error_code commit(asio::error_code& ec) {
    ...
    asio::error_code rollback(asio::error_code& ec) {
