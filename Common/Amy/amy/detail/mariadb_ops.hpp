...
int mysql_start(
    asio::error_code& ec, F f, R* r, mysql_handle m, Args... args) {
  clear_error(ec);
...
template <typename F, typename R, typename... Args>
int mysql_continue(
    asio::error_code& ec, F f, R* r, mysql_handle m, int status) {
  clear_error(ec);
...
inline int mysql_autocommit_start(
    my_bool* ret, mysql_handle m, bool mode, asio::error_code& ec) {
  return mysql_start(ec, ::mysql_autocommit_start, ret, m, mode ? 1 : 0);
}

inline int mysql_autocommit_cont(
    my_bool* ret, mysql_handle m, int status, asio::error_code& ec) {
...
inline int mysql_real_connect_start(mysql_handle* ret, mysql_handle m,
    ...
    unsigned long client_flag, asio::error_code& ec) {
...
inline int mysql_next_result_start(
    int* ret, mysql_handle m, asio::error_code& ec) {
...
inline int mysql_fetch_row_start(row_type* ret, detail::mysql_handle m,
    result_set_handle rs, asio::error_code& ec) {
  clear_error(ec);
...
inline int mysql_fetch_row_cont(row_type* ret, mysql_handle m,
    result_set_handle rs, int status, asio::error_code& ec) {
  clear_error(ec);
...
inline int mysql_commit_start(
    my_bool* ret, detail::mysql_handle m, asio::error_code& ec) {
