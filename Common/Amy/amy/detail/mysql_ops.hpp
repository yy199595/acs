                 ...
                 asio::error_code& ec)
{
    if (return_value == nullptr)
        ec = asio::error_code(::mysql_errno(m),
...
inline mysql_handle mysql_init(mysql_handle m, asio::error_code& ec) {
    clear_error(ec);
...
inline int mysql_next_result(mysql_handle m, asio::error_code& ec) {
    clear_error(ec);
