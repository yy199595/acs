...
public:
  ...
  explicit mariadb_service(asio::io_service& io_service);
  ...
  asio::error_code query(implementation_type& impl,
      std::string const& stmt, asio::error_code& ec);
  ...
  asio::error_code autocommit(
      implementation_type& impl, bool mode, asio::error_code& ec);

  asio::error_code commit(
      implementation_type& impl, asio::error_code& ec);

  asio::error_code rollback(
      implementation_type& impl, asio::error_code& ec);
...
struct mariadb_service::implementation {
  ...
  std::unique_ptr<asio::posix::stream_descriptor> ev_;
