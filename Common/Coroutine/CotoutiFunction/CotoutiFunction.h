...
namespace Sentry {
	...
	namespace xx {
		...
		class Method3 : public Closure {
		public:
			Method3(F&& f, T* o, P1&& p1, P2 && p2, P3 && p3)
				: _f(std::forward<F>(f)), _o(o), _p1(std::forward<P1>(p1)),
