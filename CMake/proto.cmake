...
elseif(MSVC)
    if(EXISTS ${source_path})
        ...
        execute_process(COMMAND cmd /c copy ${source_path} ${exe_path})
    else()
...
if(has_protoc) # 生成源码
    ...
    foreach(msg ${proto_files})
        ...
        execute_process(COMMAND ${protoc_exe} ${PROTO_FLAGS} --cpp_out=${DST_DIR} ${msg})
    endforeach()
