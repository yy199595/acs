...
namespace XCode 
{
	 ...
	 constexpr int ActivityHasStarted = 76;//活动已经开始
	 constexpr int ActivityHasStoped = 77;//活动已经结束
	 constexpr int ActivityNotExist = 78;//活动不存在
	 constexpr int ActivityHasApply = 79;//已经报名了活动
	 constexpr int NotFoundData = 80;//找不到数据
	 constexpr int CreateOrderFrequently = 81;//创建订单太过于频繁
	 constexpr int OrderAlreadyRefund = 82;//订单已经退款
	 constexpr int RequestWxApiError = 83;//请求微信api错误
	 constexpr int OrderNotPay = 84;//订单未支付
	 constexpr int RefundNotSupported = 85;//订单不支持退款，请联系客服
	 constexpr int OrderExpTime = 86;//订单已经过期
	 constexpr int ActivityMaxNum = 87;//活动人数已满
	 constexpr int PermissionDenied = 88;//权限不足
	 constexpr int WaitAdminApprove = 89;//等待管理员审批
	 constexpr int CancellationSponsorActivity = 90;//发布人主动取消活动
	 constexpr int ExistingClub = 91;//已经加入俱乐部
	 constexpr int PleaseRemoveMember = 92;//请移除俱乐部成员
	 constexpr int LoginInAgain = 93;//重新登录
	 constexpr int RefundAmountError = 94;//退款金额错误
	 constexpr int UseCouponFail = 95;//使用优惠卷失败
	 constexpr int NotFoundCoupon = 96;//找不到优惠券
	 constexpr int ShareExpired = 97;//分享已经过期
	 constexpr int WALLET_TYPE_VIP = 98;//会员卡分销佣金
	 constexpr int WALLET_TYPE_ACTIVITY = 99;//活动分销佣金
	 constexpr int WALLET_TYPE_ACTIVITY_SETTLE = 100;//活动费用结算
	 constexpr int CityHaveAdmin = 101;//城市已经有主理人
	 constexpr int OrderSalleat = 102;//订单已经结算
