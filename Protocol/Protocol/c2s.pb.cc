...
Rpc_Response::Rpc_Response()
  : ::google::protobuf::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:c2s.Rpc.Writer)
}
Rpc_Response::Rpc_Response(const Rpc_Response& from)
  ...
  // @@protoc_insertion_point(copy_constructor:c2s.Rpc.Writer)
}
...
Rpc_Response::~Rpc_Response() {
  // @@protoc_insertion_point(destructor:c2s.Rpc.Writer)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:c2s.Rpc.Writer)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 4: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("c2s.Rpc.Writer.error_str");
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:c2s.Rpc.Writer)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:c2s.Rpc.Writer)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:c2s.Rpc.Writer)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
...
void Rpc_Response::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:c2s.Rpc.Writer)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:c2s.Rpc.Writer)
}

::google::protobuf::uint8* Rpc_Response::InternalSerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:c2s.Rpc.Writer)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:c2s.Rpc.Writer)
  return target;
}

size_t Rpc_Response::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:c2s.Rpc.Writer)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:c2s.Rpc.Writer)
  GOOGLE_DCHECK_NE(&from, this);
  const Rpc_Response* source =
      ::google::protobuf::DynamicCastToGenerated<Rpc_Response>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:c2s.Rpc.Writer)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:c2s.Rpc.Writer)
    MergeFrom(*source);
  }
}

void Rpc_Response::MergeFrom(const Rpc_Response& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:c2s.Rpc.Writer)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:c2s.Rpc.Writer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:c2s.Rpc.Writer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
