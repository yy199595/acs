...
namespace SoEasy
{
	...
	{
	public:
		ObjectEntity(const long long id);
	...
	template<typename T>
	inline typename T * ObjectEntity::GetComponent()
	{
	...
	template<typename T>
	inline typename T * ObjectEntity::AddComponent()
	{
	...
	template<typename T>
	inline typename bool ObjectEntity::RemoveComponent()
	{
		const char * name = TypeReflection<T>::Name;
	...
	template<typename T>
	inline typename TypeReflection<T>::Type * ObjectEntity::GetOrAddComponent()
	{
		T * component = this->GetComponent<T>();
		return component == nullptr ? this->AddComponent<T>() : component;
	}
	
	TYPE_REFLECTION(ObjectEntity);
}